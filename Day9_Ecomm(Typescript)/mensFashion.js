...
//Men's Collection
var renderMensFashion = document.querySelector(".renderMensFashion");
function getMensFashion() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, mensWear, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    mensWear = data.filter(function (item) { return item.category === "men's clothing"; });
                    mensWear.forEach(function (ele) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Error fetching Men's Fashion:", error_1);
                    return [3 /*break*/, 4];
