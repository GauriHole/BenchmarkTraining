...
//Jewelery
var renderJewllary = document.querySelector(".renderjewelery");
function getJewelery() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, jwellary, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    jwellary = data.filter(function (item) { return item.category === "jewelery"; });
                    jwellary.forEach(function (ele) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Error fetching Jewllary:", error_1);
                    return [3 /*break*/, 4];
