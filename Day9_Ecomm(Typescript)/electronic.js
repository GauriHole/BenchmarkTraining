...
var renderElectronics = document.querySelector(".renderElectronics");
function getElectronics() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, elctronics, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    elctronics = data.filter(function (item) { return item.category === "electronics"; });
                    elctronics.forEach(function (ele) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Error fetching Electronics:", error_1);
                    return [3 /*break*/, 4];
